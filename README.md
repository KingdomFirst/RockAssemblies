...
This is an open-source repository of [Kingdom First Solutions](https://www.kingdomfirstsolutions.com/rock) for all public Rock RMS Assemblies. Remember to check our [RockBlocks](https://github.com/KingdomFirst/RockBlocks) repo. Most of our code in this repository is targeted for RockRMS v13 and earlier. There are some changes for v13 that are breaking changes to prior versions, we will tag 12.8 if you would like to use any of our code that was tested on 12.8 and prior. There are also hotfix branches available for early access versions in the event the code does not work properly in newer versions.
