...
{
    public class ZRScheduleRequest : ZRRequestBodyBase
    {
        public ZRScheduleRequestBody Params { get; set; }
    }

    public class ZRScheduleRequestBody
    {
    ...
    public class ZRScheduleMeetingInfoSetting
    {
