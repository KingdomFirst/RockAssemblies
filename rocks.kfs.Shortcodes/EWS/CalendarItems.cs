...
{[ ewscalendaritems applicationid:'{{ applicationid }}' tenantid:'{{ tenantid }}' appsecret:'{{ appsecret }}' calendarmailbox:'kfscalendar@kingdomfirstsolutions.com' ]}
 ...
 {[ endewscalendaritems ]}</pre>
        ...
        <ul>
            <li><strong>applicationid</strong> REQUIRED - The Application (client) ID in Microsoft Azure for the registered application that has access to the target mailbox. This value can be either encrypted or non-encrypted. It is recommended this value be stored as a global attribute of type EncryptedText and passed to the shortcode directly from the global attribute value for higher security.</li>
            <li><strong>tenantid</strong> REQUIRED - The Directory (tenant) ID in Microsoft Azure for the registered application that has access to the target mailbox. This value can be either encrypted or non-encrypted. It is recommended this value be stored as a global attribute of type EncryptedText and passed to the shortcode directly from the global attribute value for higher security.</li>
            <li><strong>appsecret</strong> REQUIRED - The Secret Value in Microsoft Azure for the registered application that has access to the target mailbox. This value can be either encrypted or non-encrypted. It is recommended this value be stored as a global attribute of type EncryptedText and passed to the shortcode directly from the global attribute value for higher security.</li>
