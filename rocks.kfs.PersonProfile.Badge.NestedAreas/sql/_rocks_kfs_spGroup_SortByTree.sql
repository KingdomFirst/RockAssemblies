...
--
-- Creates SP that can be executed via RunSQL
-- Rock Job nightly to keep Groups sorted
-- =============================================

CREATE PROC [dbo].[_rocks_kfs_spGroup_SortByTree](@GroupTypeId INT)
AS
