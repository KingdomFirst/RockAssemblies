...
{
    /// <summary>
    /// A tabular report field that displays the name of the Schedule tied to a RoomOccurrence.
    /// </summary>
    [Description( "Show Schedule Name" )]
    [Export( typeof( DataSelectComponent ) )]
    [ExportMetadata( "ComponentName", "Select Schedule" )]
    public class ScheduleNameSelect : DataSelectComponent
    {
        /// <summary>
