...
{
    /// <summary>
    /// A tabular report field that displays Start Date of the Schedule tied to a RoomOccurrence.
    /// </summary>
    [Description( "Show Schedule Start Date" )]
    [Export( typeof( DataSelectComponent ) )]
    [ExportMetadata( "ComponentName", "Select Schedule Start Date" )]
    public class ScheduleStartDateSelect : DataSelectComponent
    {
        /// <summary>
        ...
        public override System.Linq.Expressions.Expression GetExpression( Rock.Data.RockContext context, System.Linq.Expressions.MemberExpression entityIdProperty, string selection )
        {
            ...
            scheduleQuery = occurrenceQuery.Select( ro => ro.Schedule.EffectiveStartDate.Value.ToShortDateString() );
