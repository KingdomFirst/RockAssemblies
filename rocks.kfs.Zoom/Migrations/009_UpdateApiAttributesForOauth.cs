...
namespace rocks.kfs.Zoom.Migrations
{
    ...
    public partial class UpdateApiAttributesForOauth : Migration
    {
        ...
        public override void Up()
        {
            ...
            // Delete old Zoom JWT App attributes
        ...
        public override void Down()
        {
            ...
            RockMigrationHelper.UpdateEntityAttribute( "rocks.kfs.Zoom.ZoomApp", Rock.SystemGuid.FieldType.ENCRYPTED_TEXT, "", "", "API Key", "The API Key for the Zoom Marketplace JWT app to use for KFS Zoom integration elements.", 0, "", "D53A2B48-C8B4-4481-B2AB-139CAF90C78C", "rocks.kfs.ZoomApiKey" );
            RockMigrationHelper.UpdateEntityAttribute( "rocks.kfs.Zoom.ZoomApp", Rock.SystemGuid.FieldType.ENCRYPTED_TEXT, "", "", "API Secret", "The API Secret for the Zoom Marketplace JWT app to use for KFS Zoom integration elements.", 0, "", "CB89B071-4866-41BD-ACB1-1810F5224A82", "rocks.kfs.ZoomApiSecret" );
        }
    }
}