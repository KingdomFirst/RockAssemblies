...
namespace rocks.kfs.StepsToCare.Migrations
{
    ...
    public class AddFieldTypeAndAttributeMatrix : Migration
    {
        public override void Up()
        {
            ...
            var attributeMatrixTemplateEmailId = new AttributeMatrixTemplateService( rockContextEmail ).Get( SystemGuid.Attribute.CATEGORY_MATRIX_CARE_TOUCHES.AsGuid() ).Id.ToString();

            // Entity: Rock.Model.AttributeMatrixItem Attribute: Note Template
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.AttributeMatrixItem", SystemGuid.FieldType.NOTE_TEMPLATE, "AttributeMatrixTemplateId", attributeMatrixTemplateEmailId, "Note Template", "Note Template", @"", 0, @"", SystemGuid.Attribute.MATRIX_ATTRIBUTE_TOUCH_NOTE_TEMPLATE, "NoteTemplate" );
            // Entity: Rock.Model.AttributeMatrixItem Attribute: Minimum Care Touches
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.AttributeMatrixItem", Rock.SystemGuid.FieldType.INTEGER, "AttributeMatrixTemplateId", attributeMatrixTemplateEmailId, "Minimum Care Touches", "Minimum Care Touches", @"", 1, @"", SystemGuid.Attribute.MATRIX_ATTRIBUTE_TOUCH_MINIMUM_TOUCHES, "MinimumCareTouches" );
            // Entity: Rock.Model.AttributeMatrixItem Attribute: Minimum Care Touch Hours
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.AttributeMatrixItem", Rock.SystemGuid.FieldType.INTEGER, "AttributeMatrixTemplateId", attributeMatrixTemplateEmailId, "Minimum Care Touch Hours", "Minimum Care Touch Hours", @"", 2, @"", SystemGuid.Attribute.MATRIX_ATTRIBUTE_TOUCH_MINIMUM_HOURS, "MinimumCareTouchHours" );
            // Entity: Rock.Model.AttributeMatrixItem Attribute: Notify All Assigned
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.AttributeMatrixItem", Rock.SystemGuid.FieldType.BOOLEAN, "AttributeMatrixTemplateId", attributeMatrixTemplateEmailId, "Notify All Assigned", "Notify All Assigned", @"By default, only the ""follow up worker"" will get notified. If you choose this option anyone assigned to the need will receive this notification.", 3, @"False", SystemGuid.Attribute.MATRIX_ATTRIBUTE_TOUCH_NOTIFY_ALL, "NotifyAllAssigned" );
            ...
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.AttributeMatrixItem", Rock.SystemGuid.FieldType.BOOLEAN, "AttributeMatrixTemplateId", attributeMatrixTemplateEmailId, "Recurring", "Recurring", @"Is this care touch requirement recurring? Each recurrence of this notification will happen in the set amount of time after the last ""touch"" using the set note template.", 4, @"False", SystemGuid.Attribute.MATRIX_ATTRIBUTE_TOUCH_RECURRING, "Recurring" );
            ...
            RockMigrationHelper.AddAttributeQualifier( "50128254-2C44-421D-A53E-F67236B67A2F", "attributematrixtemplate", attributeMatrixTemplateEmailId, "AE2E6015-5281-4367-A5C3-DC278644B038" );
        }
