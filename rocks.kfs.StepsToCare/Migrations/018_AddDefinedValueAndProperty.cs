...
namespace rocks.kfs.StepsToCare.Migrations
{
    ...
    public class AddDefinedValueAndProperty : Migration
    {
        public override void Up()
        {
            ...
            RockMigrationHelper.AddDefinedTypeAttribute( SystemGuid.DefinedType.CARE_NEED_CATEGORY, "A75DFC58-7A1B-4799-BF31-451B2BBE38FF", "Follow Up After", "FollowUpAfter", "Will repeat the notification and change to follow up status the provided number of days after the status has changed to \"Waiting\". If you have a value set in this attribute, by default when this category is selected it will enable \"Custom Follow Up\" and set the Follow Up After value to this on the Care Need.", 6563, "", "CF59CDFF-8C98-487B-B2E7-A2CA496ACB87" );
