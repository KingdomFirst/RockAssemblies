...
namespace rocks.kfs.FundraisingParticipantSummary.Migrations
{
    ...
    internal class AddSystemCommunication : Migration
    {
        ...
        public override void Up()
        {
            ...
            RockMigrationHelper.UpdateSystemCommunication( "Plugins", "Fundraising Participant Summary", "", "", "", "", "", "Summary of Donations for {{ BeginDateTime | Date:'M/d/yyyy' }} - {{ 'Now' | Date:'M/d/yyyy' }}", @"{{ 'Global' | Attribute:'EmailHeader' }}
