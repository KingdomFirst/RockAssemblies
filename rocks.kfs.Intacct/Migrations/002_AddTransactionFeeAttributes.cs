...
namespace com.kfs.Intacct.Migrations
{
    ...
    public class AddTransactionFeeAttributes : Migration
    {
        ...
        public override void Up()
        {
            ...
            RockMigrationHelper.UpdateEntityAttribute( "Rock.Model.FinancialGateway", Rock.SystemGuid.FieldType.SINGLE_SELECT, "", "", "Gateway Fee Processing", "Set how the Intacct Export plugin will process gateway transaction fees. Ignore (Default): No special handling of transaction fees will be performed; Include: If a Fee Account attribute on either the financial gateway or financial account is set, debit and credit entries for any transaction fees will be added to journal entry sent to Intacct.", 0, "0", KFSConst.Attribute.FINANCIAL_GATEWAY_FEE_PROCESSING, "rocks.kfs.Intacct.FEEPROCESSING", true );
            RockMigrationHelper.AddAttributeQualifier( KFSConst.Attribute.FINANCIAL_GATEWAY_FEE_PROCESSING, "values", "0^Ignore,1^Include", "BA5F38C9-78D4-43D9-86ED-5248A8AADFA5" );
