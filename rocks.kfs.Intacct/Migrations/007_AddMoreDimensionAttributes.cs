...
namespace rocks.kfs.Intacct.Migrations
{
    ...
    public class AddMoreDimensionAttributes : Migration
    {
        ...
        public override void Up()
        {
            ...
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Task", "The Intacct dimension for Task to be used for assigned Credit Account. A valid Default Credit Project value is required for Credit Task value to be used.", 2, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_TASK, "rocks.kfs.Intacct.TASKID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Customer", "The Intacct dimension for Customer to be used for assigned Credit Account.", 6, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_CUSTOMER, "rocks.kfs.Intacct.CUSTOMERID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Item", "The Intacct dimension for Item to be used for assigned Credit Account.", 7, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_ITEM, "rocks.kfs.Intacct.ITEMID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Vendor", "The Intacct dimension for Vendor to be used for assigned Credit Account.", 8, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_VENDOR, "rocks.kfs.Intacct.VENDORID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Employee", "The Intacct dimension for Employee to be used for assigned Credit Account.", 9, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_EMPLOYEE, "rocks.kfs.Intacct.EMPLOYEEID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Contract Id", "The Intacct dimension for Contract Id to be used for assigned Credit Account. Not supported in Other Receipts mode.", 9, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_CONTRACTID, "rocks.kfs.Intacct.CONTRACTID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Warehouse Id", "The Intacct dimension for Warehouse Id to be used for assigned Credit Account. Not supported in Other Receipts mode.", 9, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_EMPLOYEE, "rocks.kfs.Intacct.WAREHOUSEID" );

            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Task", "The Intacct dimension for Task to be used for assigned Debit Account. A valid Default Debit Project value is required for Credit Task value to be used.", 12, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_TASK_DEBIT, "rocks.kfs.Intacct.DEBITTASKID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Customer", "The Intacct dimension for Customer to be used for assigned Debit Account.", 16, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_CUSTOMER_DEBIT, "rocks.kfs.Intacct.DEBITCUSTOMERID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Item", "The Intacct dimension for Item to be used for assigned Debit Account.", 17, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_ITEM_DEBIT, "rocks.kfs.Intacct.DEBITITEMID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Vendor", "The Intacct dimension for Vendor to be used for assigned Debit Account.", 18, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_VENDOR_DEBIT, "rocks.kfs.Intacct.DEBITVENDORID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Employee", "The Intacct dimension for Employee to be used for assigned Debit Account.", 19, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_EMPLOYEE_DEBIT, "rocks.kfs.Intacct.DEBITEMPLOYEEID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Contract Id", "The Intacct dimension for Contract Id to be used for assigned Debit Account. Not supported in Other Receipts mode.", 9, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_CONTRACTID_DEBIT, "rocks.kfs.Intacct.DEBITCONTRACTID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Warehouse Id", "The Intacct dimension for Warehouse Id to be used for assigned Debit Account. Not supported in Other Receipts mode.", 9, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_WAREHOUSEID_DEBIT, "rocks.kfs.Intacct.DEBITWAREHOUSEID" );
            ...
            RockMigrationHelper.UpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Account", "Account number to use for debit column. Required by Intacct.", 10, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_DEBIT_ACCOUNT, "rocks.kfs.Intacct.DEBITACCOUNTNO" );
            RockMigrationHelper.UpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.DEFINED_VALUE, "", "", "Default Debit Project", "Designates the Project for the assigned Debit Account at the Financial Account Level.", 11, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_PROJECT_DEBIT, "rocks.kfs.Intacct.DEBITPROJECTID" );
            RockMigrationHelper.UpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Class", "The Intacct dimension for Class Id to be used for assigned Debit Account.", 13, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_CLASS_DEBIT, "rocks.kfs.Intacct.DEBITCLASSID" );
            RockMigrationHelper.UpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Department", "The Intacct dimension for Department Id to be used for assigned Debit Account.", 14, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_DEPARTMENT_DEBIT, "rocks.kfs.Intacct.DEBITDEPARTMENT" );
            RockMigrationHelper.UpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Location", "The Intacct dimension for Location Id to be used for assigned Debit Account. Required if multi-entity enabled.", 15, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_LOCATION_DEBIT, "rocks.kfs.Intacct.DEBITLOCATION" );
            RockMigrationHelper.UpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Transaction Fee Account", "Expense account number for gateway transaction fees.", 20, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_FEE_ACCOUNT, "rocks.kfs.Intacct.FEEACCOUNTNO" );
        }
