...
namespace rocks.kfs.Intacct.Migrations
{
    ...
    public class AddMoreDimensionAttributes : Migration
    {
        ...
        public override void Up()
        {
            ...
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Customer", "The Intacct dimension for Customer to be used for assigned Credit Account.", 5, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_CUSTOMER, "rocks.kfs.Intacct.CUSTOMERID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Item", "The Intacct dimension for Item to be used for assigned Credit Account.", 6, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_ITEM, "rocks.kfs.Intacct.ITEMID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Task", "The Intacct dimension for Task to be used for assigned Credit Account.", 7, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_TASK, "rocks.kfs.Intacct.TASKID" );
            ...
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Customer", "The Intacct dimension for Customer to be used for assigned Debit Account.", 15, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_CUSTOMER_DEBIT, "rocks.kfs.Intacct.DEBITCUSTOMERID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Item", "The Intacct dimension for Item to be used for assigned Debit Account.", 16, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_ITEM_DEBIT, "rocks.kfs.Intacct.DEBITITEMID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Task", "The Intacct dimension for Task to be used for assigned Debit Account.", 17, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_TASK_DEBIT, "rocks.kfs.Intacct.DEBITTASKID" );
            ...
            RockMigrationHelper.UpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Class", "The Intacct dimension for Class Id to be used for assigned Debit Account.", 12, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_CLASS_DEBIT, "rocks.kfs.Intacct.DEBITCLASSID" );
            RockMigrationHelper.UpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Department", "The Intacct dimension for Department Id to be used for assigned Debit Account.", 13, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_DEPARTMENT_DEBIT, "rocks.kfs.Intacct.DEBITDEPARTMENT" );
            RockMigrationHelper.UpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Location", "The Intacct dimension for Location Id to be used for assigned Debit Account. Required if multi-entity enabled.", 14, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_LOCATION_DEBIT, "rocks.kfs.Intacct.DEBITLOCATION" );
