...
namespace rocks.kfs.Intacct.Migrations
{
    ...
    public class AddDebitAccountAttributes : Migration
    {
        ...
        public override void Up()
        {
            ...
            // project
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.DEFINED_VALUE, "", "", "Default Debit Project", "Default Debit Project", "Designates the Project for the assigned Debit Account at the Financial Account Level.", 6, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_PROJECT_DEBIT, "rocks.kfs.Intacct.DEBITPROJECTID" );
            ...
            // gl attributes
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Class", "Debit Class", "The Intacct dimension for Class Id to be used for assigned Debit Account.", 7, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_CLASS_DEBIT, "rocks.kfs.Intacct.DEBITCLASSID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Department", "Debit Department", "The Intacct dimension for Department Id to be used for assigned Debit Account.", 8, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_DEPARTMENT_DEBIT, "rocks.kfs.Intacct.DEBITDEPARTMENT" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Location", "Debit Location", "The Intacct dimension for Location Id to be used for assigned Debit Account. Required if multi-entity enabled.", 9, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_LOCATION_DEBIT, "rocks.kfs.Intacct.DEBITLOCATION" );
            ...
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.DEFINED_VALUE, "", "", "Default Credit Project", "Default Credit Project", "Designates the Project for the assigned Credit Account at the Financial Account Level.", 1, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_PROJECT, "rocks.kfs.Intacct.PROJECTID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Class", "Credit Class", "The Intacct dimension for Class Id to be used for assigned Credit Account.", 2, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_CLASS, "rocks.kfs.Intacct.CLASSID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Department", "Credit Department", "The Intacct dimension for Department Id to be used for assigned Credit Account.", 3, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_DEPARTMENT, "rocks.kfs.Intacct.DEPARTMENT" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Location", "Credit Location", "The Intacct dimension for Location Id to be used for assigned Credit Account. Required if multi-entity enabled.", 4, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_LOCATION, "rocks.kfs.Intacct.LOCATION" );

            // reorder remaining attributes
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Account", "Credit Account", "Account number to use for credit column. Required by Intacct.", 0, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_CREDIT_ACCOUNT, "rocks.kfs.Intacct.ACCOUNTNO" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Account", "Debit Account", "Account number to use for debit column. Required by Intacct.", 5, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_DEBIT_ACCOUNT, "rocks.kfs.Intacct.DEBITACCOUNTNO" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Transaction Fee Account", "Transaction Fee Account", "Expense account number for gateway transaction fees.", 10, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_FEE_ACCOUNT, "rocks.kfs.Intacct.FEEACCOUNTNO" );
        ...
        public override void Down()
        {
            ...
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.DEFINED_VALUE, "", "", "Default Project", "Default Project", "Designates the Project at the Financial Account Level", 0, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_PROJECT, "rocks.kfs.Intacct.PROJECTID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Class", "Class", "The Intacct dimension for Class Id.", 4, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_CLASS, "rocks.kfs.Intacct.CLASSID" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Department", "Department", "The Intacct dimension for Department Id.", 5, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_DEPARTMENT, "rocks.kfs.Intacct.DEPARTMENT" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Location", "Location", "The Intacct dimension for Location Id. Required if multi-entity enabled.", 6, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_LOCATION, "rocks.kfs.Intacct.LOCATION" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Credit Account", "Credit Account", "Account number to use for credit column. Required by Intacct.", 1, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_CREDIT_ACCOUNT, "rocks.kfs.Intacct.ACCOUNTNO" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Debit Account", "Debit Account", "Account number to use for debit column. Required by Intacct.", 2, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_DEBIT_ACCOUNT, "rocks.kfs.Intacct.DEBITACCOUNTNO" );
            RockMigrationHelper.AddOrUpdateEntityAttribute( "Rock.Model.FinancialAccount", Rock.SystemGuid.FieldType.TEXT, "", "", "Transaction Fee Account", "Transaction Fee Account", "Expense account number for gateway transaction fees.", 3, "", SystemGuid.Attribute.FINANCIAL_ACCOUNT_FEE_ACCOUNT, "rocks.kfs.Intacct.FEEACCOUNTNO" );
        }
    }
}
