...
namespace rocks.kfs.Avalanche.Migrations
{
    ...
    public class AddBlocks : Migration
    {
        ...
        {
            RockMigrationHelper.UpdateBlockType( "Audio Player Block", "Mobile audio player.", "~/Plugins/rocks_kfs/Avalanche/AudioPlayerBlock.ascx", "Avalanche", "7515DA74-D55F-44C0-ABC0-A6D9DBFEF76B" );
            RockMigrationHelper.UpdateBlockType( "Avalanche Configuration", "Configuration settings for Avalanche.", "~/Plugins/rocks_kfs/Avalanche/AvalancheConfiguration.ascx", "Avalanche > Settings", "2E5AAAEB-C731-4F7A-B502-BA67589AF69F" );
            RockMigrationHelper.UpdateBlockType( "Button", "A button.", "~/Plugins/rocks_kfs/Avalanche/ButtonBlock.ascx", "Avalanche", "65CE4075-6A52-40F4-8ED0-6540F387BE76" );
            RockMigrationHelper.UpdateBlockType( "Avalanche Event Calendar Lava", "Renders a particular calendar using Lava.", "~/Plugins/rocks_kfs/Avalanche/CalendarLava.ascx", "Avalanche", "A5129AF8-9744-4974-9EC3-F5D898DC7B77" );
            RockMigrationHelper.UpdateBlockType( "Content Channel Mobile List", "Block to display a list of content itmes.", "~/Plugins/rocks_kfs/Avalanche/ContentChannelMobileList.ascx", "Avalanche", "641A5E85-F2B4-46A3-8B9F-4AA759E33804" );
            RockMigrationHelper.UpdateBlockType( "Group Attendance Block", "Mobile block to take group attendance.", "~/Plugins/rocks_kfs/Avalanche/GroupAttendanceBlock.ascx", "Avalanche", "06A2663C-9292-4202-ACEE-A5F884671E55" );
            RockMigrationHelper.UpdateBlockType( "Group List", "Block to show a list of groups.", "~/Plugins/rocks_kfs/Avalanche/GroupListBlock.ascx", "Avalanche", "55CB76A9-74F8-4F31-97B5-2567EBB25DFF" );
            RockMigrationHelper.UpdateBlockType( "Group Member List Block", "Mobile block to show group members of a group.", "~/Plugins/rocks_kfs/Avalanche/GroupMemberListBlock.ascx", "Avalanche", "E6BAE8D3-B244-400F-8092-AFD27156F6BD" );
            RockMigrationHelper.UpdateBlockType( "Icon Block", "Font Awesome Icon.", "~/Plugins/rocks_kfs/Avalanche/IconBlock.ascx", "Avalanche", "1112BA70-CE0D-4158-8A2B-D5F2FD217BAE" );
            RockMigrationHelper.UpdateBlockType( "Icon Button", "An icon button", "~/Plugins/rocks_kfs/Avalanche/IconButton.ascx", "Avalanche", "4CCA5B0C-63A6-40C1-B981-648663029092" );
            RockMigrationHelper.UpdateBlockType( "Image Block", "A button.", "~/Plugins/rocks_kfs/Avalanche/ImageBlock.ascx", "Avalanche", "47C24453-10F9-4A11-9BD0-3D9B1CC943D3" );
            RockMigrationHelper.UpdateBlockType( "Label Block", "A button.", "~/Plugins/rocks_kfs/Avalanche/LabelBlock.ascx", "Avalanche", "A42B3143-E970-4BEC-A694-9BCB37B9B737" );
            RockMigrationHelper.UpdateBlockType( "Login App", "Login Screen", "~/Plugins/rocks_kfs/Avalanche/Login.ascx", "Avalanche", "857ABAF2-1F35-404E-827D-F4ADD629CBDF" );
            RockMigrationHelper.UpdateBlockType( "Markdown Detail", "A control to display Markdown.", "~/Plugins/rocks_kfs/Avalanche/MarkdownDetail.ascx", "Avalanche", "35B0B2B4-BE73-4C03-8F56-DD8D28EBD7FA" );
            RockMigrationHelper.UpdateBlockType( "Mobile Content Item", "Block to show a mobile content item.", "~/Plugins/rocks_kfs/Avalanche/MobileContentItem.ascx", "Avalanche", "C2E57F26-0F77-4844-A298-1A24B088D645" );
            RockMigrationHelper.UpdateBlockType( "Mobile ListView Lava", "Displays mobile list view from lava", "~/Plugins/rocks_kfs/Avalanche/MobileListViewLava.ascx", "Avalanche", "755D550E-FB64-4DBE-A054-9D0141A18001" );
            RockMigrationHelper.UpdateBlockType( "Mobile Workflow", "Mobile block to allow workflow to be accessed from app", "~/Plugins/rocks_kfs/Avalanche/MobileWorkflow.ascx", "Avalanche", "6B9DDC12-D7B3-4521-9D49-B79BE6578CB1" );
            RockMigrationHelper.UpdateBlockType( "Note Block", "Allows the user to make a single personal note for an entity. Useful for sermons and blog posts.", "~/Plugins/rocks_kfs/Avalanche/NoteBlock.ascx", "Avalanche", "275D5C9B-7D0B-42EE-A0D1-198B5C1A8A3B" );
            RockMigrationHelper.UpdateBlockType( "Person Card", "Card to display person's information from guid.", "~/Plugins/rocks_kfs/Avalanche/PersonCard.ascx", "Avalanche", "9610B4D8-EB3B-45ED-B8DF-9E97FA1DF7AF" );
            RockMigrationHelper.UpdateBlockType( "Phone Number Login", "Block to log in with your phone number", "~/Plugins/rocks_kfs/Avalanche/PhoneNumberLogin.ascx", "Avalanche", "912A2617-C744-4D65-A0E1-A795469CFD0D" );
            RockMigrationHelper.UpdateBlockType( "Prayer Request Entry", "Block to add prayer requests to the prayer system via mobile.", "~/Plugins/rocks_kfs/Avalanche/PrayerRequestEntry.ascx", "Avalanche", "8189E73E-7E5C-4D37-BD62-FD7FBDEEC9FD" );
            RockMigrationHelper.UpdateBlockType( "Preload Block", "Block to preload pages in Avalanche.", "~/Plugins/rocks_kfs/Avalanche/PreloadBlock.ascx", "Avalanche", "01CFA67B-429A-432E-BA56-4F4289917D06" );
            RockMigrationHelper.UpdateBlockType( "Text Over Image Block", "Creates an image with text centered over it.", "~/Plugins/rocks_kfs/Avalanche/TextOverImage.ascx", "Avalanche", "207ABAA7-8C45-472E-8649-3E4E895184B7" );
            RockMigrationHelper.UpdateBlockType( "Video Player Block", "Mobile video player.", "~/Plugins/rocks_kfs/Avalanche/VideoPlayerBlock.ascx", "Avalanche", "6FA66F35-5D80-4BD5-AD39-71618C1FFEAD" );
            RockMigrationHelper.UpdateBlockType( "WebViewBlock", "A control to display Markdown.", "~/Plugins/rocks_kfs/Avalanche/WebViewBlock.ascx", "Avalanche", "78FC6291-B753-4782-8AED-DB04681F1D0E" );
            ...
            RockMigrationHelper.UpdateBlockType( "Event Filter", "Creates a form for event filtering ", "~/Plugins/rocks_kfs/Avalanche/EventFilter.ascx", "Avalanche", "DE3997BC-AE8E-43B0-A41B-1F52C1BFE3B0" );
            RockMigrationHelper.UpdateBlockType( "Public Profile Edit Block", "Allows the user to update their personal information", "~/Plugins/rocks_kfs/Avalanche/PersonProfileEdit.ascx", "Avalanche", "41D83AAD-F2B8-43DA-978E-1391B4427280" );
            RockMigrationHelper.UpdateBlockType( "Person Profile Family", "Block to show a list of Family members.", "~/Plugins/rocks_kfs/Avalanche/PersonProfileFamily.ascx", "Avalanche", "36569642-F6D7-4EAC-AF0E-C8238BEEAF7E" );
            // Add Block to Layout: No Scroll Site: KFS Avalanche
            ...
            // Add Block to Layout: Simple Site: KFS Avalanche
            ...
            //// Add Block to  Site: KFS Avalanche (v9?)
            ...
            // Add Block to Layout: Main Page Site: KFS Avalanche
            ...
            // Add Block to Page: KFS Avalanche Home Page Site: KFS Avalanche
            ...
            // Add Block to Page: Sermons Site: KFS Avalanche
            ...
            // Add Block to Page: Visit Site: KFS Avalanche
            ...
            // Add Block to Page: Connect Site: KFS Avalanche
            ...
            // Add Block to Page: Give Site: KFS Avalanche
            ...
            // Add Block to Page: Footer Site: KFS Avalanche
            ...
            // Add Block to Page: Visit Detail Site: KFS Avalanche
            ...
            // Add Block to Page: Series Detail Site: KFS Avalanche
            ...
            // Add Block to Page: Sermon Detail Site: KFS Avalanche
            ...
            // Add Block to Page: Sermon Detail Audio Site: KFS Avalanche
            ...
            // Add Block to Page: Groups Site: KFS Avalanche
            ...
            // Add Block to Page: Baptism Site: KFS Avalanche
            ...
            // Add Block to Page: Events Site: KFS Avalanche
            ...
            // Add Block to Page: Contact Us Site: KFS Avalanche
            ...
            // Add Block to Page: Event Detail Site: KFS Avalanche
            ...
            // Add Block to Page: Serve Site: KFS Avalanche
            ...
            // Add Block to Page: Other Blocks Site: KFS Avalanche
            ...
            // Add Block to Page: Login Site: KFS Avalanche
            ...
            // Add Block to Page: Prayer Request Site: KFS Avalanche
            ...
            // Add Block to Page: Person Card Site: KFS Avalanche
            ...
            // Add Block to Page: Group Attendance Site: KFS Avalanche
            ...
            // Add Block to Page: Group List Site: KFS Avalanche
            ...
            // Add Block to Page: Group Member List Site: KFS Avalanche
            ...
            // Add Block to Page: Note Block Site: KFS Avalanche
            ...
            // Add Block to Page: Webview Block Site: KFS Avalanche
            ...
            Sql( @"UPDATE [Block] SET [Order] = 0 WHERE [Guid] = 'FCB9F034-0036-48DC-B588-6FBE969938C9'" );  // Page: KFS Avalanche Home Page,  Zone: Main,  Block: Preload Block
            ...
            Sql( @"UPDATE [Block] SET [Order] = 1 WHERE [Guid] = 'A2487BA5-843D-4D7E-92A6-36A52027EB26'" );  // Page: KFS Avalanche Home Page,  Zone: Main,  Block: Text Over Image Block - Sermons
            ...
            Sql( @"UPDATE [Block] SET [Order] = 2 WHERE [Guid] = '7E1A52B6-68A9-423F-88DB-4E402360FED0'" );  // Page: KFS Avalanche Home Page,  Zone: Main,  Block: Text Over Image Block - Events
            ...
            Sql( @"UPDATE [Block] SET [Order] = 3 WHERE [Guid] = '99865F0D-BD8A-4AA7-88A2-D7D7859E1992'" );  // Page: KFS Avalanche Home Page,  Zone: Main,  Block: Text Over Image Block - Visit
        ...
        public override void Down()
        {
            ...
            // Remove Block: Icon Block, from , Layout: No Scroll, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "962317D3-42D0-4152-839E-35AAF2BD66E2" );
            // Remove Block: WebViewBlock, from Page: Webview Block, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "E43CF3E1-D8FA-41B3-AED9-E09FAA594F7B" );
            // Remove Block: Button, from Page: Connect, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "99CAEBAF-9E80-410E-BB33-9DCD6B4ECF9B" );
            // Remove Block: Group Attendance Block, from Page: Group Attendance, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "BD824150-F1B1-4A7D-93FA-5A4AA7AE565D" );
            // Remove Block: Note Block, from Page: Note Block, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "FB213CB9-C91F-4546-9371-73839FBD447A" );
            // Remove Block: Group Member List Block, from Page: Group Member List, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "D53AE8B1-9F7B-457C-A2AB-297D7E0B0C71" );
            // Remove Block: Group List, from Page: Group List, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "13472A3E-A5FD-47C1-A382-4243BBE0BC98" );
            // Remove Block: Person Card, from Page: Person Card, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "86FF3353-4FEE-4272-BD9B-78B5C373051A" );
            // Remove Block: Prayer Request Entry, from Page: Prayer Request, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "BFB73CDC-B2B6-4484-B35F-3BC25C430ECB" );
            // Remove Block: Login App, from Page: Login, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "0DB6C226-836D-4CEB-B3CC-9F50ED499DD5" );
            // Remove Block: Mobile ListView Lava - Child Pages, from Page: Other Blocks, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "253974FD-3F00-4677-86A4-F4F8C84F275C" );
            // Remove Block: WebViewBlock, from Page: Give, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "FAF7BF20-4F53-47CC-B7E7-A5223BED5188" );
            // Remove Block: Mobile ListView Lava, from Page: Serve, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "77E64C5A-7F2A-4634-BEA4-46ECBAF4E56D" );
            // Remove Block: Markdown Detail, from Page: Serve, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "897EB15F-66BB-44F6-BF89-C9012CA36BCA" );
            // Remove Block: Text Over Image Block, from Page: Serve, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "454646F6-C317-4764-B514-4AF84C1E7FEC" );
            // Remove Block: Text Over Image Block - Serve, from Page: Connect, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "2901482E-A8C5-4A47-8EEB-2D3C9E0EA407" );
            // Remove Block: Markdown Detail, from Page: Baptism, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "6AA0CB59-E4BA-4E74-8198-749EEB553835" );
            // Remove Block: Button, from Page: Baptism, Site: KFS Avalanche
            ...
            // Remove Block: Text Over Image Block, from Page: Baptism, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "F6B935B9-6DA2-421A-9645-F9EF7B432E8C" );
            // Remove Block: Mobile Button, from Page: Event Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "C454F889-AB57-4D38-A18F-195D60445EDF" );
            // Remove Block: Markdown Detail, from Page: Event Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "10F85187-7796-45FC-A65D-4EC1314E3609" );
            // Remove Block: Label Block, from Page: Event Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "897FE435-F9E8-4755-AC87-5B273A415DCD" );
            // Remove Block: Image Block, from Page: Event Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "BAAA075C-AD3F-4A0B-AF0C-D9462760D16F" );
            // Remove Block: Event Filter, from Page: Events, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "A9D36E34-4D02-4179-B6DE-EF30B341D1D9" );
            // Remove Block: Text Over Image Block, from Page: Events, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "FB586E92-764C-4321-871F-47C38D768E94" );
            // Remove Block: Avalanche Event Calendar Lava, from Page: Events, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "713083B7-B5A8-416C-9603-594589A67B8D" );
            // Remove Block: Mobile Workflow, from Page: Contact Us, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "F05B2A93-CEF8-4EAE-9358-EACC73C31173" );
            // Remove Block: Next Steps Button, from Page: Groups, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "D0B758C4-18E1-45DE-82B0-70906E45B99A" );
            // Remove Block: Next Steps detail, from Page: Groups, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "87B3FD61-73E7-4BEF-AC56-1A96E497E916" );
            // Remove Block: Button - Attend Growth Track, from Page: Groups, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "6B2D9BCB-6229-4859-BA77-9E4BF34AE181" );
            // Remove Block: Markdown Detail, from Page: Groups, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "898CD5D8-AB1E-4267-8084-161FFBAA7820" );
            // Remove Block: Text Over Image Block, from Page: Groups, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "5C6A4458-56A3-4F60-8792-5271326DED00" );
            // Remove Block: Text Over Image Block - Events, from Page: Connect, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "E7E0ADD1-0863-492E-B7D7-A32B5680816F" );
            // Remove Block: Text Over Image Block - Groups, from Page: Connect, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "44D7ED68-22F4-4D1F-B443-75FF6B9F791B" );
            // Remove Block: Text Over Image Block - Baptism, from Page: Connect, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "DC43E7F1-A294-4D99-B37A-CC04F18BD32C" );
            // Remove Block: Preload Block, from Page: Connect, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "C6A448AB-B39B-48D1-9EDC-06062BF98766" );
            // Remove Block: Preload Block, from Page: KFS Avalanche Home Page, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "FCB9F034-0036-48DC-B588-6FBE969938C9" );
            // Remove Block: Image Block, from Page: Sermon Detail Audio, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "9735B56B-32A3-45CE-9298-5C1F7EFB3DEA" );
            // Remove Block: Icon Button - Watch, from Page: Sermon Detail Audio, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "F915EB5A-9260-4681-9A49-0C6778D2F084" );
            // Remove Block: Icon Button - Listen, from Page: Sermon Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "BA50E899-CEAB-4816-8AD0-A650889882A4" );
            // Remove Block: Audio Player Block, from Page: Sermon Detail Audio, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "7761BC7C-DDE7-4DCB-81C9-720339A24477" );
            // Remove Block: Markdown Detail, from Page: Sermon Detail Audio, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "8F975583-92F5-4827-909B-97D3D09E4BEC" );
            // Remove Block: Markdown Detail, from Page: Sermon Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "11955742-2F20-40BB-B304-7865C992C7B4" );
            // Remove Block: Video Player Block, from Page: Sermon Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "7E110550-159D-463A-A532-673564806896" );
            // Remove Block: Markdown Detail, from Page: Series Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "EDC51B07-CA23-4415-8997-E03A60D5FA5A" );
            // Remove Block: Image Block, from Page: Series Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "A47A5177-CD5B-4A1F-9F6D-C1718DB0BA16" );
            // Remove Block: Mobile ListView Lava - Sermon Content, from Page: Series Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "7AA9738F-BA87-4761-9FD3-FF8A38703473" );
            // Remove Block: Content Channel Mobile List, from Page: Sermons, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "724E2C2F-213B-4959-9F01-1957C77733DD" );
            // Remove Block: More Info Button, from Page: Visit Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "20E578B0-BAB2-40DA-944D-9189465C6A96" );
            // Remove Block: Parking Map Button, from Page: Visit Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "41BD57CC-71E3-4DC0-957C-F9265061FA65" );
            // Remove Block: Description/Location summary text, from Page: Visit Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "BDAAFA41-836E-4C27-9696-847D685D3980" );
            // Remove Block: Header Title, from Page: Visit Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "089C9B48-AE89-416C-98FB-32304206DB20" );
            // Remove Block: Image Block, from Page: Visit Detail, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "941F3F7B-2922-4D29-9B8E-FE22A5337486" );
            // Remove Block: Campus Listview, from Page: Visit, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "14EFA755-D8F8-4BC2-A199-E67B2E960A95" );
            // Remove Block: Welcome Text, from Page: Visit, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "0B08E530-6763-473F-A338-C7E2B2F753BA" );
            // Remove Block: Label Block - Welcome, from Page: Visit, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "57096CBB-21E8-4EF5-ABD3-05B2414225D0" );
            // Remove Block: Text Over Image Block - Plan a visit, from Page: Visit, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "C730CAF4-F17F-4D9C-B2F3-9A6A29491FD7" );
            // Remove Block: Icon Block - Back, from , Layout: Simple, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "D2DFBCB4-894C-4E5C-A534-110B21A00FEB" );
            // Remove Block: Listview Footer, from Page: Footer, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "0DBA9AAB-FA2E-4C53-B820-A4C0B3FF29D0" );
            // Remove Block: Text Over Image Block - Visit, from Page: KFS Avalanche Home Page, Site: KFS Avalanche
            RockMigrationHelper.DeleteBlock( "99865F0D-BD8A-4AA7-88A2-D7D7859E1992" );
            // Remove Block: Text Over Image Block - Events, from Page: KFS Avalanche Home Page, Site: KFS Avalanche
            ...
            // Remove Block: Text Over Image Block - Sermons, from Page: KFS Avalanche Home Page, Site: KFS Avalanche
